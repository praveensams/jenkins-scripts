   ...
   sleep 10 
    ...
    then
       ...
       #)
        ...
        azcopy --source . --destination https://exprdstrgcdn.blob.core.windows.net/exprdeccdn01/ImagesSections/hybris/cdn/$location/_ui/ --dest-key zqireCeb6SebWU1xS9uleijwSnE+Sf0JCwqrBIKx44DxEpAnDpp0yZdLenN6rojte/58/aS0gQ6toi/fL80NSg== --quiet --recursive   --resume "/mnt/myjournal"
       ls -l 
       )
...
azcopy --set-content-type 'text/css'  --source .  --destination  https://exprdstrgcdn.blob.core.windows.net/exprdeccdn01/ImagesSections/hybris/cdn/$location/_ui/responsive/theme-extra/css --dest-key zqireCeb6SebWU1xS9uleijwSnE+Sf0JCwqrBIKx44DxEpAnDpp0yZdLenN6rojte/58/aS0gQ6toi/fL80NSg== --quiet   --resume "/mnt/myjournal" --recursive
       )

       (
		cd /hybris/play_prod/hybris/bin/custom/extrastorefront/web/webroot/_ui/responsive/common/js

azcopy --set-content-type 'application/javascript'  --source .  --destination  https://exprdstrgcdn.blob.core.windows.net/exprdeccdn01/ImagesSections/hybris/cdn/$location/_ui/responsive/common/js --dest-key zqireCeb6SebWU1xS9uleijwSnE+Sf0JCwqrBIKx44DxEpAnDpp0yZdLenN6rojte/58/aS0gQ6toi/fL80NSg== --quiet   --resume "/mnt/myjournal" --recursive
       )
